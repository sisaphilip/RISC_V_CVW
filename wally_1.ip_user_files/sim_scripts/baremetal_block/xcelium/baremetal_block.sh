...
#
# Script generated by Vivado on Mon May 12 20:47:53 EAT 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : baremetal_block.sh
...
#
# Usage        : baremetal_block.sh
#                baremetal_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                baremetal_block.sh [-reset_run]
#                baremetal_block.sh [-reset_log]
#                baremetal_block.sh [-help]
#
...
#                script (type 'baremetal_block.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_bram_ctrl_v4_1_11 -libname xil_defaultlib -libname blk_mem_gen_v8_4_9 -libname ahblite_axi_bridge_v3_0_28 -libname smartconnect_v1_0 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_33 -libname axi_vip_v1_1_19 -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_16 -libname xlconstant_v1_1_9 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_bram_ctrl_v4_1_11 xil_defaultlib blk_mem_gen_v8_4_9 ahblite_axi_bridge_v3_0_28 smartconnect_v1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_33 axi_vip_v1_1_19 lib_cdc_v1_0_3 proc_sys_reset_v5_0_16 xlconstant_v1_1_9)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "baremetal_block.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./baremetal_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/0127/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/ec67/hdl" +incdir+"/home/ishfisav/Desktop/amd2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/0127/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/ec67/hdl" +incdir+"/home/ishfisav/Desktop/amd2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_9 $xmvlog_opts +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/0127/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/ec67/hdl" +incdir+"/home/ishfisav/Desktop/amd2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/5ec1/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/0127/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/ec67/hdl" +incdir+"/home/ishfisav/Desktop/amd2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../bd/baremetal_block/ip/baremetal_block_blk_mem_gen_0_0/sim/baremetal_block_blk_mem_gen_0_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvhdl -work ahblite_axi_bridge_v3_0_28 -V93 $xmvhdl_opts \
  ...
  xmvlog -work smartconnect_v1_0 $xmvlog_opts -sv +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/0127/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/ec67/hdl" +incdir+"/home/ishfisav/Desktop/amd2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/0127/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/ec67/hdl" +incdir+"/home/ishfisav/Desktop/amd2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_33 $xmvlog_opts +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/0127/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/ec67/hdl" +incdir+"/home/ishfisav/Desktop/amd2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/3ee4/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_19 $xmvlog_opts -sv +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/0127/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/ec67/hdl" +incdir+"/home/ishfisav/Desktop/amd2024.2/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xlconstant_v1_1_9 $xmvlog_opts +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/f0b6/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/0127/hdl/verilog" +incdir+"../../../../wally_1.gen/sources_1/bd/baremetal_block/ipshared/ec67/hdl" +incdir+"/home/ishfisav/Desktop/amd2024.2/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.baremetal_block xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.baremetal_block -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ishfisav/wally_1/wally_1.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log baremetal_block_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./baremetal_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: baremetal_block.sh [-help]\n\
Usage: baremetal_block.sh [-step]\n\
Usage: baremetal_block.sh [-lib_map_path]\n\
Usage: baremetal_block.sh [-reset_run]\n\
Usage: baremetal_block.sh [-reset_log]\n\
Usage: baremetal_block.sh [-keep_index]\n\
Usage: baremetal_block.sh [-noclean_files]\n\n\
