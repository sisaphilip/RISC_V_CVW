...
export RDI_DATADIR="/home/ishfisav/Desktop/amd2024.2/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_bram_ctrl_v4_1_11 -L blk_mem_gen_v8_4_9 -L ahblite_axi_bridge_v3_0_28 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L axi_vip_v1_1_19 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L xlconstant_v1_1_9 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot baremetal_block xil_defaultlib.baremetal_block xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim baremetal_block -key {Behavioral:sim_1:Functional:baremetal_block} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c80a.protoinst" -protoinst "protoinst_files/baremetal_block.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/design_2.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ishfisav/Desktop/amd2024.2/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb baremetal_block.wdb xsim.dir libdpi.so)
