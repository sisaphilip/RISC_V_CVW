...
#
# Script generated by Vivado on Sun Nov 03 13:05:53 EAT 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_2 xil_defaultlib.design_2 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ishfisav/Desktop/vitis2024.1/Vivado/2024.1/data/xsim"
  fi
