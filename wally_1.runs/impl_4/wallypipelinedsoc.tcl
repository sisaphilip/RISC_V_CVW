namespace eval ::optrace {
  variable script "/home/ishfisav/wally_1/wally_1.runs/impl_4/wallypipelinedsoc.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /home/ishfisav/wally_1/wally_1.runs/synth_1_copy_6/wallypipelinedsoc.dcp
...
OPTRACE "link_design" START { }
  set_param project.isImplRun true
  link_design -top wallypipelinedsoc -part xck26-sfvc784-2LV-c 
...
OPTRACE "opt_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_drc -file wallypipelinedsoc_drc_opted.rpt -pb wallypipelinedsoc_drc_opted.pb -rpx wallypipelinedsoc_drc_opted.rpx"  }
  set_param project.isImplRun false
OPTRACE "opt_design reports" END { }
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force wallypipelinedsoc_opt.dcp
...
OPTRACE "Power Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force wallypipelinedsoc_pwropt.dcp
...
OPTRACE "place_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_io -file wallypipelinedsoc_io_placed.rpt" "report_utilization -file wallypipelinedsoc_utilization_placed.rpt -pb wallypipelinedsoc_utilization_placed.pb" "report_control_sets -verbose -file wallypipelinedsoc_control_sets_placed.rpt"  }
  set_param project.isImplRun false
OPTRACE "place_design reports" END { }
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force wallypipelinedsoc_placed.dcp
...
OPTRACE "Post-Place Power Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force wallypipelinedsoc_postplace_pwropt.dcp
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force wallypipelinedsoc_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_drc -file wallypipelinedsoc_drc_routed.rpt -pb wallypipelinedsoc_drc_routed.pb -rpx wallypipelinedsoc_drc_routed.rpx" "report_methodology -file wallypipelinedsoc_methodology_drc_routed.rpt -pb wallypipelinedsoc_methodology_drc_routed.pb -rpx wallypipelinedsoc_methodology_drc_routed.rpx" "report_power -file wallypipelinedsoc_power_routed.rpt -pb wallypipelinedsoc_power_summary_routed.pb -rpx wallypipelinedsoc_power_routed.rpx" "report_route_status -file wallypipelinedsoc_route_status.rpt -pb wallypipelinedsoc_route_status.pb" "report_timing_summary -max_paths 10 -report_unconstrained -file wallypipelinedsoc_timing_summary_routed.rpt -pb wallypipelinedsoc_timing_summary_routed.pb -rpx wallypipelinedsoc_timing_summary_routed.rpx" "report_incremental_reuse -file wallypipelinedsoc_incremental_reuse_routed.rpt" "report_clock_utilization -file wallypipelinedsoc_clock_utilization_routed.rpt" "report_bus_skew -warn_on_violation -file wallypipelinedsoc_bus_skew_routed.rpt -pb wallypipelinedsoc_bus_skew_routed.pb -rpx wallypipelinedsoc_bus_skew_routed.rpx"  }
  set_param project.isImplRun false
OPTRACE "route_design reports" END { }
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force wallypipelinedsoc_routed.dcp
...
OPTRACE "route_design write_checkpoint" END { }
  write_checkpoint -force wallypipelinedsoc_routed_error.dcp
...
OPTRACE "phys_opt_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_timing_summary -max_paths 10 -report_unconstrained -warn_on_violation -file wallypipelinedsoc_timing_summary_postroute_physopted.rpt -pb wallypipelinedsoc_timing_summary_postroute_physopted.pb -rpx wallypipelinedsoc_timing_summary_postroute_physopted.rpx" "report_bus_skew -warn_on_violation -file wallypipelinedsoc_bus_skew_postroute_physopted.rpt -pb wallypipelinedsoc_bus_skew_postroute_physopted.pb -rpx wallypipelinedsoc_bus_skew_postroute_physopted.rpx"  }
  set_param project.isImplRun false
OPTRACE "phys_opt_design reports" END { }
OPTRACE "Post-Route Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force wallypipelinedsoc_postroute_physopt.dcp
