...
HD_PWD='/home/ishfisav/wally_1/wally_1.runs/synth_1_copy_6'
cd "$HD_PWD"
...
EAStep vivado -log wallypipelinedsoc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wallypipelinedsoc.tcl
